...
# This script recursively finds all .tif and .heic images (both in IMG folders and elsewhere)  
...
# First, find and process all .tif and .heic files in the current directory (non-recursive)
...
echo "$img_dirs" | grep -v "^$" | while read dir; do
    ...
    # Process .tif and .heic files in this directory
...
# Finally, do a recursive search to find any other .tif or .heic files that might be in other directories
echo "Checking for any remaining .tif or .heic files in other directories..."
process_tif_files "."
process_heic_files "."

echo "All done! Converted all .tif and .heic files to .jpg format with 95% quality."
